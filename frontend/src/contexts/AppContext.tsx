...
import { AppState, NormEntry, ProposalEntry, EvaluatedProposal, ExpenditureEntry, Model } from '@/types';
...
interface AppContextType {
  ...
  setExpenditure: (expenditure: ExpenditureEntry[]) => void;
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const contextValue: AppContextType = {
    ...
    setExpenditure: (expenditure: ExpenditureEntry[]) => 
      dispatch({ type: 'SET_EXPENDITURE', payload: expenditure }),
